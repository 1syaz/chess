      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Dialog open={createRoomOpen} onOpenChange={setCreateRoomOpen}>
          <DialogTrigger asChild>
            <Card className="bg-background border-charcoal hover:border-border transition-colors cursor-pointer group">
              <CardContent className="p-6 text-center">
                <Plus className="h-12 w-12 text-purple-400 mx-auto mb-4 group-hover:scale-110 transition-transform" />
                <h3 className="text-white font-semibold mb-2">Create Room</h3>
          ...
          {/* TODO remove this dialog add new one */}
              ...
              <div>
                ...
                <Select value={timeControl} onValueChange={setTimeControl}>
                  ...
                  <SelectContent className="bg-slate-700 border-slate-600">
                    <SelectItem value="3+2">Bullet (3+2)</SelectItem>
        ...
        <Card className="bg-background border-charcoal hover:border-border transition-colors cursor-pointer group">
          <CardContent className="p-6 text-center">
            ...
            <h3 className="text-white font-semibold mb-2">Tournament</h3>
            <p className="text-slate-400 text-sm">
